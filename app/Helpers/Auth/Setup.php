...
class Setup {
    ...
    public function __construct() {
        ...
        define("SESSION_DURATION_RM", "+1 month"); // (Remember Me) Amount of time session lasts for. Only modify if you know what you are doing ! Default = +1 month
		define("SESSION_DURATION", "+1 day"); // Amount of time session lasts for. ! Default = +1 day
